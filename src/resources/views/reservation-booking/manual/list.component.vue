        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <search-component q="manual_name" @event="search$" placeholder="Name.."/>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(value, key) in data.data" :key="key">
                                    <td>{{ value.id }}</td>
                                    <td>{{ value.personal_details.first_name }} {{ value.personal_details.last_name }}</td>
